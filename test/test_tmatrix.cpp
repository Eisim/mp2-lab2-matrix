...
TEST(TDynamicMatrix, can_add_matrices_with_equal_size)
{
	...
	m1[0][0] = 1; m1[0][1] = 2; m1[1][0] = 3; m1[1][1] = 4;
	m2[0][0] = 1; m2[0][1] = 1; m2[1][0] = 2; m2[1][1] = 2;
	res = m1 + m2;
	exp[0][0] = 2; exp[0][1] = 3; exp[1][0] = 5; exp[1][1] = 6;
  EXPECT_EQ(res,exp);
}
...
TEST(TDynamicMatrix, can_subtract_matrices_with_equal_size)
{
	...
	m2[0][0] = 1; m2[0][1] = 1; m2[1][0] = 2; m2[1][1] = 2;
	res = m1 - m2;
	exp[0][0] = 0; exp[0][1] = 1; exp[1][0] = 1; exp[1][1] = 2;
	EXPECT_EQ(res, exp);
}
